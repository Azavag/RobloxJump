...
namespace QuantumTek.QuantumUI
{
    ...
    public enum QUI_ElementAnimationType
    {
        ...
        None,
        /// <summary> The AnimatorState with the QUI_ElementAnimation's skinName will play. </summary>
        Name,
    ...
    {
        [Tooltip("The skinName of the animation.")]
        public string name;
        [Tooltip("The type of the animation.")]
        public QUI_ElementAnimationType type;
        [Tooltip("The skinName of the animator parameter to use.")]
        ...
        /// </summary>
        /// <param skinName="animator"></param>
        /// <param skinName="normalizedTime"></param>
