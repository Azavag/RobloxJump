...
namespace QuantumTek.QuantumUI
{
    ...
    public abstract class QUI_Element : MonoBehaviour
    {
        ...
        [Tooltip("The animation skinName from the animation preset on the element animator to play at the start if active.")]
        [SerializeField] private string startActiveAnimation = "Active";
        [Tooltip("The animation skinName from the animation preset on the element animator to play at the start if inactive.")]
        ...
        /// <summary>
        /// Plays an audio clip with the given skinName from the element audio preset.
        /// </summary>
        /// <param skinName="name"></param>
