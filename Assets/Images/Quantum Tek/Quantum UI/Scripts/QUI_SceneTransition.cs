...
namespace QuantumTek.QuantumUI
{
    ...
    public enum QUI_LoadType
    {
        ...
        Instant,
        /// <summary> The scene will load asynchronously (in the backgroundImage), while showing some loading UI after the start of the scene transition effect. </summary>
        LoadingUI,
        /// <summary> The scene will load asynchronously (in the backgroundImage), while showing a loading scene. </summary>
        LoadingScene
    }
    ...
    public class QUI_SceneTransition : MonoBehaviour
    {
        ...
        [Tooltip("The skinName of the loading scene, if the type is LoadingScene.")]
        public string loadingSceneName = "";
        [Tooltip("The skinName of the transition animation to play when entering a scene.")]
        public string enterSceneAnimation;
        [Tooltip("The skinName of the transition animation to play when exiting a scene.")]
        ...
        /// </summary>
        /// <param skinName="sceneName"></param>
